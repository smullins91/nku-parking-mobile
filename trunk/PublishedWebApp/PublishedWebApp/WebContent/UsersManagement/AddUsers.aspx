<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="ParkingManagement.WebContent.UsersManagement.WebForm1" %>
         ...
         <div class="modal-dialog" style="margin-top:0">
            <div class="modal-content">
              <div class="modal-header">
                 <h4 class="modal-title" id="myModalLabel">Users Management >> Add a new user</h4>
              </div>
                    ...
                    <div class="form-group">
                         <asp:Label ID="lblPassword" runat="server" Text="Password:*" class="col-sm-4 control-label"></asp:Label>
                          <div class="col-sm-8">
                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" class="form-control" MaxLength="10"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvTxtPassword" runat="server" ErrorMessage="Password is required!" ControlToValidate="txtPassword" Display="Static" CssClass="userErrorMessage"></asp:RequiredFieldValidator>
                          </div>
                        </div>
                 <div class="form-group">
                         <asp:Label ID="lblConfPassword" runat="server" Text="Confirm Password:*" class="col-sm-4 control-label"></asp:Label>
                          <div class="col-sm-8">
                            <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" class="form-control" MaxLength="10"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="rfvTxtConfirmPassword" runat="server" ErrorMessage="Password is required!" ControlToValidate="txtConfirmPassword" Display="Static" CssClass="userErrorMessage"></asp:RequiredFieldValidator>
                              <asp:CompareValidator ID="cvPassword" runat="server" ErrorMessage="Passwords do not match!" ControlToCompare="txtConfirmPassword" ControlToValidate="txtPassword" CssClass="userErrorMessage" Display="Static"></asp:CompareValidator>
                          </div>
                        </div>
                        <div class="form-group">
